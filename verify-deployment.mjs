...
const required = ["index.html", "examples.html", "privacy.html", "robots.txt", "sitemap.xml", "_headers", "2026-07-09-AX-Readiness-ROI-og-image.png"];
const failures = [];
...
const expectations = [
  ...
  [html.includes('contextmenu'), "context-menu blocking missing from index"],
  [examples.includes('contextmenu'), "context-menu blocking missing from examples"],
  ...
  [html.includes('content-protected') && examples.includes('content-protected'), "text-selection protection missing"],
  [html.includes('selectstart') && html.includes('dragstart') && examples.includes('selectstart') && examples.includes('dragstart'), "selection or drag protection missing"],
